...
* **Detailed Metadata:** Automatically tags downloads with full FLAC metadata and embeds high-resolution cover art.
* **Privacy First:** Your authentication tokens are stored strictly locally. No telemetry, no logs, no tracking.
